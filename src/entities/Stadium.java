...
/**
 * Verwaltet den Stadion-Hintergrund: Tribüne, animierte Zuschauer, Rasen und Werbebanden.
 * Enthält außerdem die Tor-Instanzen ({@link #leftGoal}, {@link #rightGoal}).
 * <p>
 * Zuschauer-Arme werden alle 12 Frames neu gewürfelt (vorberechnetes Array),
 * um 240 {@code Math.random()}-Aufrufe pro Frame und damit Flackern zu vermeiden.
 */
public class Stadium {
    ...
    private final GradientPaint skyGradient   = new GradientPaint(0, 0,   new Color(135, 206, 235), 0, 400, Color.WHITE);
    private final GradientPaint grassGradient = new GradientPaint(0, 350, new Color(34,  139,  34),  0, 700, new Color(0, 100, 0));
    ...
    public Stadium() {
        ...
        for (int i = 0; i < crowdColors.length; i++) {
            crowdColors[i] = new Color(r.nextInt(255), r.nextInt(255), r.nextInt(255));
            crowdArms[i]   = r.nextFloat() > 0.95f;
        }
    ...
    /**
     * Aktualisiert Animations-Timer, Tor-Shake und Zuschauer-Arme.
    ...
    /**
     * Zeichnet den vollständigen Stadion-Hintergrund.
     * Die Tore werden hier <em>nicht</em> gezeichnet; das übernimmt {@code GamePanel}
     * mit {@code drawBack} → Spieler → {@code drawFront}.
     *
    ...
    /**
     * Zeichnet den Hintergrund ohne Jubel-Animation.
     * Wird im Team-Auswahl-Bildschirm verwendet.
     *
     * @param g Grafik-Kontext
     */
