 ...
 * <p>
 * Die Darstellung ist in zwei Ebenen aufgeteilt ({@link #drawBack} / {@link #drawFront}),
 * damit Spieler optisch zwischen Netz und vorderem Pfosten stehen können.
 * Der vordere Pfosten ist bewusst nur Vordergrund-Kulisse (Tiefen-Illusion des Genres):
 * Der Ball fliegt „hinter ihm" ins Tor; Kollision hat nur die Latte.
 */
public class Goal {
    ...
    /**
     * Aktueller Wackel-Versatz. Wird einmal pro Frame in {@link #update} gewürfelt,
     * damit Netz ({@code drawBack}) und Pfosten ({@code drawFront}) synchron wackeln.
     */
    private int shakeDx = 0, shakeDy = 0;
    ...
    /**
     * Aktualisiert den Wackel-Timer und würfelt den Frame-Versatz.
    ...
    /**
     * Zeichnet die hintere Tor-Ebene: Netz und hinterer Pfosten.
     * Muss <em>vor</em> den Spielern gerendert werden.
     *
    ...
    /**
     * Zeichnet die vordere Tor-Ebene: Latte und vorderer Pfosten.
     * Muss <em>nach</em> den Spielern gerendert werden, um Tiefenwirkung zu erzeugen.
     *
     * @param g Grafik-Kontext
     */
    ...
    /**
     * Verschiebt den Grafik-Kontext um den aktuellen Wackel-Versatz.
     * Der Versatz wird in {@link #update} bestimmt und ist für alle
     * Zeichenebenen desselben Frames identisch.
     *
     * @param g Grafik-Kontext
     */
