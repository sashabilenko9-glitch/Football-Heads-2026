 ...
 * {@link #paintComponent} – ein opakes Panel mit Alpha-Hintergrundfarbe würde bei Teil-Repaints
 * (z.&nbsp;B. Button-Hover) Schlieren hinterlassen.
 */
    ...
    JButton btn =
        new JButton(text) {
          ...
          protected void paintComponent(Graphics g) {
            ...
            g2.setColor(
                new Color(
                    accent.getRed() / 7, accent.getGreen() / 7, accent.getBlue() / 7 + 5, 235));
