...
/**
 * Team-Auswahl-Bildschirm. Zeigt für jeden Spieler einen animierten Selektor
 * mit Vorschau-Panel und Pfeil-Navigation an.
 * Der Stadion-Hintergrund ist mit {@code 60%} Verdunklung als Backdrop sichtbar.
 * Beide Spieler müssen unterschiedliche Teams wählen, damit sie im Spiel
 * unterscheidbar sind.
 */
public class TeamSelectPanel extends JPanel {
    ...
    private final Stadium      bgStadium;
    ...
    public TeamSelectPanel(JFrame parentFrame, Runnable onBack) {
        ...
        buttonRow.add(createNeonButton("SPIEL BEGINNEN", new Color(0, 140, 255), e -> startGame(parentFrame)));
    ...
    /**
     * Startet das Spiel, sofern beide Spieler unterschiedliche Teams gewählt haben.
     * Bei identischer Auswahl wird stattdessen ein Hinweis angezeigt.
     *
     ...
     */
    private JButton createNeonButton(String text, Color accent,
    ...
    /**
     * Team-Selektor für einen Spieler: zeigt Teamname, animierte Vorschau und
     * Pfeil-Buttons zur Navigation.
     */
    private class TeamSelector extends JPanel {
        ...
        TeamSelector(String headerText, boolean isPlayerOne) {
            ...
            JPanel nameBg = new JPanel(new BorderLayout()) {
                @Override
                protected void paintComponent(Graphics g) {
                    Graphics2D g2 = (Graphics2D) g;
                    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        ...
        /**
         * Wechselt das ausgewählte Team um {@code dir} Schritte
         * und entfernt einen eventuell angezeigten Gleiches-Team-Hinweis.
         *
        ...
        private void refreshUI() {
            ...
            nameLabel.setText(teams[currentIndex].name.toUpperCase());
            nameLabel.repaint();
        ...
        private JButton createArrowButton(String symbol) {
            JButton btn = new JButton(symbol) {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    g2.setColor(new Color(col.getRed() / 8, col.getGreen() / 8,
                                         col.getBlue() / 8 + 4, 210));
        ...
        /**
         * Animiertes Vorschau-Panel: zeichnet die Spielerfigur mit Idle-Bob-Animation.
         * Der Spieler wird passend zur Panelhöhe skaliert und vertikal zentriert.
         * Der Animations-Timer läuft nur, solange das Panel angezeigt wird
         * ({@link #addNotify} / {@link #removeNotify}).
         */
        private class PlayerPreviewPanel extends JPanel {
