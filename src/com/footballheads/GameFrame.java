...
/**
 * Spielfenster: kombiniert {@link GamePanel} (Spielfeld), {@link InGameUI} (Steuerleiste)
 * und {@link MobileControlsPanel} (Bildschirm-Tasten-Overlay).
 */
        ...
        addComponentListener(new java.awt.event.ComponentAdapter() {
            ...
            public void componentResized(java.awt.event.ComponentEvent e) {
                SwingUtilities.invokeLater(
                    () -> mcp.setBounds(0, 0, lp.getWidth(), lp.getHeight()));
            }
        });
